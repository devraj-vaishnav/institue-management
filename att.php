...
<?php
require_once "db.php";
 // $query = $conn->prepare("SELECT * FROM user_login_data");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <h1 class="h4 fw-bold ms-5 text-gray-900 m-4"> Employee Attendance!</h1>
                            ...
                            <form method="post" class="" action="att_save.php">
                                <div class="form-group card-body row ">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <select name="att" class="form-control" required>
...
//     $name=$_POST['name'];
//     $att=$_POST['att'];
//     $conn =new mysqsli('localhost','root','','institute_db');
//     $sql="insert into `att`(name,att) value ('$name','$att')";
//     $data=mysqli_query($onn,$sql);
//     if($data) {
//         echo "save";
