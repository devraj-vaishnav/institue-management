      ...
      <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="empindex.php">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
                        <i class="fa fa-bars"></i>
                                ...
                                <h1 class="h4 fw-bold ms-5 text-gray-900 m-4"> New Employee Account!</h1>
                ...
                <form method="post" action="emp_add.php">
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col-sm-6 mb-3 mb-sm-0"">
                      ...
                      <input type="number" class="form-control" name="wnumber">
                    </div>
                  </div>
                  ...
                  <div class="mb-3">
                    ...
                    <textarea class="textarea form-control" id="read" name="radd" required></textarea>
                  </div>
                  <div class="mb-3 form-check">
                  
                    <input type="checkbox" class="form-check-input"   onclick="box()">
                    <label class="form-check-label">  </label>
                  </div>
                  <div class="mb-2">
                    <label> Permanent Address</label>
                    <textarea class="textarea form-control" id="show" name="padd"></textarea>
                  </div>
